...
const FormCustom = ({ cart, total }) => {
						...
						<Form>
							<div className="flex flex-col mb-2">
								...
								<div className="flex justify-center flex-col mt-6 items-center">
									...
									<div className="flex flex-row justify-between w-full items-center pb-4 gap-2 ">

									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-6 text-red-main">
  ...
  <path fill-rule="evenodd" d="m12.556 17.329 4.183 4.182a3.375 3.375 0 0 0 4.773-4.773l-3.306-3.305a6.803 6.803 0 0 1-1.53.043c-.394-.034-.682-.006-.867.042a.589.589 0 0 0-.167.063l-3.086 3.748Zm3.414-1.36a.75.75 0 0 1 1.06 0l1.875 1.876a.75.75 0 1 1-1.06 1.06L15.97 17.03a.75.75 0 0 1 0-1.06Z" clip-rule="evenodd" />
									...
									<p className="text-red-main text-left text-xs w-full">Para pagar con Mercadopago escribir a 3584306832.
									 Esta funcion se encuentra en mantenimiento.</p>
												</div>
