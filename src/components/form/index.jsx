              ...
              <div className="flex flex-col mb-2">
                <div className="flex justify-center flex-col  items-center">
                  ...
                  <div className="flex flex-row w-full gap-2 mb-4">
                    <button
                      type="button"
                      className={`h-20 flex-1 font-bold items-center flex justify-center gap-2 rounded-2xl ${
                    ...
                    <button
                      type="button"
                      className={`h-20 flex-1 flex-col font-bold items-center flex justify-center rounded-2xl ${
                    ...
                    <div className="flex flex-row justify-between px-3 h-auto items-start border-t border-black border-opacity-20">
                      <div className="flex flex-row items-center gap-2">
                        ...
                        <ErrorMessage
                          name="hora"
                          component="span"
                          className="text-sm text-red-500 font-coolvetica font-light mt-1"
                        />
                      </div>
                    </div>
                  </div>
