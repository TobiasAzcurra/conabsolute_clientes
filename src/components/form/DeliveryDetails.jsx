...
const DeliveryDetails = ({ getFieldProps, envio, setAddressValue }) => {
  return (
    <>
      ...
      <a className=" font-primary  mb-2 font-bold text-2xl">DIRECCIÓN:</a>
      <MyTextInput
        label="Dirección"
        name="address"
        type="text"
      ...
      {/* <AddressAutofill accessToken={accessToken ?? ''}>
        <div className="flex flex-col gap-2">
          <label
            htmlFor="address"
            className=" font-primary  mb-2 font-bold text-2xl"
          >
            DIRECCIÓN:
          </label>
          <input
            className=" font-primary  focus:border-none focus:outline-none  bg-gray-300 text-xs p-2 mb-2 text-black md:w-6/12"
