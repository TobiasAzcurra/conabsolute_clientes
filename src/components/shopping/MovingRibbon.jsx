        ...
        <div className="flex flex-row gap-4">
          <div className="flex flex-row items-center mt-2 gap-8">
            <div className="flex flex-col">
              <p
                className="text mb-[-20px] text-end text-black font-black   font-primary "
                style={{ opacity: 0.85 }}
              >
                Vas a pedir más.
              </p>
              <p
                style={{ opacity: 0.85 }}
                className=" text-black font-black text-9xl italic  font-primary "
              >
                ANHELO
              </p>
            </div>
          ...
          <div className="flex flex-row items-center mt-2 gap-8">
            <div className="flex flex-col">
              ...
              <p
                style={{ opacity: 0.85 }}
                className="text mt-[-20px] text-start text-black font-black   font-primary  mb-4"
              >
                Vas a pedir más.
              </p>
            </div>
