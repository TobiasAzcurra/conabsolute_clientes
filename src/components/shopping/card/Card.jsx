      ...
      >
        ...
        <div className="shadow-md  shadow-gray-200 rounded-3xl ">
          <div className="relative w-full aspect-square  overflow-hidden rounded-3xl bg-gray-100">
            ...
            {/* Badge de NOTE - Arriba a la izquierda */}
            {data.note && (
              <div className="absolute top-2 left-2 z-30">
                <div className=" bg-gray-50 text-black font-primary font-light text-xs font-bold px-4 h-10 items-center justiy-center flex-row flex rounded-full gap-2 ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
