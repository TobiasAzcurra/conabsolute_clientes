					...
					<div className="flex items-center flex-col w-full px-4 mt-8 space-y-16 overflow-y-auto">
						{pedidosPagados.map((currentOrder, index) => (
							...
							>
								...
								{/* Nuevo botón "Llamar cadete" */}
								{currentOrder.cadete !== "NO ASIGNADO" && (
									<div
										onClick={() =>
											window.open(`tel:${currentOrder.telefonoCadete}`, "_self")
										} // Cambiar a la funcionalidad de llamada
										className="bg-black w-full text-gray-100 font-coolvetica text-center justify-center h-20 flex items-center text-2xl rounded-3xl mt-4 font-bold cursor-pointer"
									>
										<svg
											xmlns="http://www.w3.org/2000/svg"
											viewBox="0 0 24 24"
