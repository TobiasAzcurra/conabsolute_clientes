...
import RatingModal from '../../components/pedido/RatingModal';
import {
  getCadetePhone,
...
const Pedido = () => {
  ...
  const handleSubmitRating = async (fecha, orderId, rating) => {
    try {
      await updateRatingForOrder(fecha, orderId, rating);
      // Actualizar el estado después de enviar la calificación
    } catch (error) {
              ...
              >
                ...
                <div className="w-full">
                  ...
                  <RatingModal
                    ...
                    onClose={() => setIsModalRatingOpen(false)}
