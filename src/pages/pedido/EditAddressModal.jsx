...
const EditAddressModal = ({ isOpen, onClose, orderId, currentAddress, onSuccess }) => {
  ...
  const handleUpdateAddress = async () => {
    ...
    try {
      ...
      setError('Hubo un error al actualizar la dirección. Por favor intenta nuevamente.');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl w-full max-w-lg">
        <div className="p-6">
          ...
          <p className="text-gray-600 mb-4">Dirección actual: {currentAddress}</p>
