      ...
      {shouldShowCarruselAndNavMenu && (
        <div className="relative mb-[90px]">
          <div className="flex justify-center w-full ">
            <div className="bg-gray-100 border border-black border-opacity-20 shadow-black h-10 flex items-center justify-center absolute z-50 top-4 font-coolvetica rounded-full px-4 left-4 right-4">
              <svg
